  ...
  return (
    <div className="min-h-screen px-5 pt-10 pb-32 bg-[#0a0a0a]">
      ...
      <div className="flex flex-col items-stretch">
        ...
        disabled={!text.trim()}
        className="mt-6 w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 disabled:opacity-40 disabled:cursor-not-allowed text-white font-bold py-6 rounded-3xl text-lg shadow-2xl shadow-cyan-500/30 transition-all duration-200 flex items-center justify-center gap-3"
      >
